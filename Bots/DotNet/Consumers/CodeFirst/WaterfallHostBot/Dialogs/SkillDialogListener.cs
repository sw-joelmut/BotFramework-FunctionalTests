...
{
    public class SkillDialogListener : SkillDialog
    {
        ...
        public SkillDialogListener(SkillDialogOptions dialogOptions, string dialogId = null, IBotTelemetryClient logger = null)
            : base(dialogOptions, dialogId)
        {
            _logger = logger;
        ...
        private async Task<Activity> SendToSkillAsync(ITurnContext context, Activity activity, string skillConversationId, CancellationToken cancellationToken)
        {
            ...
            _logger.TrackEvent("BeforePostActivityAsync", new Dictionary<string, string>
            {
                ...
                { "skillConversationId", skillConversationId },
